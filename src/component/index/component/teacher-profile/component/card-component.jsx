	...
	return(
		<Fragment>
			<div id="wrapper-crad-for-teacher-profile" className=" block lg:flex justify-around w-full h-full lg:h-[400px]">
				<div id="image-cover" data-aos="fade-right" className=" w-full lg:w-[30%] h-[250px] lg:h-full bg-green rounded-[10px] bg-cover bg-no-repeat lg:mt-0" style={{ backgroundImage : `url(${props.image})`}}></div>
				<div id="description" data-aos="fade-left" className="h-full w-full lg:w-[60%] flex flex-col border-box mt-4 lg:mt-0">
