...
import WhatisComponent from "./component/whats-is/whats-is-component"
import TujuanComponent from "./component/tujuan/tujuan-component"

const Majorpage = function({name, whatis, tujuan}) {
    return(
        <Fragment>
            <div id="wrapper" className="h-full w-full">
                <JumbotronComponent name={name}/>
                ...
                <WhatisComponent name={name} whatis={whatis}/>
                <TujuanComponent name={name} tujuan={tujuan}/>
            </div>
        </Fragment>
    )
}
