	...
	return(
		<Fragment>
			<div id="wrapper-for-teacher-profile" className="w-full h-full relative lg:p-[10px] border-box mb-[80px] mt-7 lg:mt-0">
				<div id="sub-wrapper-for-teacher-profile" className="w-[90%] overflow-hidden lg:w-[60%] m-auto h-full p-[10px] border-box">
					...
					<div id="main-content-for-teacher-profile" className="w-full h-full">
						...
						<div id="wrapper-for-list-teacher" className="w-full lg:w-[95%] m-auto h-[150px] overflow-y-hidden flex mt-7 lg:mt-4 lg:p-[10px] border-box overflow-auto">
							<div className="w-[100000px] flex">	
								{
									TeacherData.map(data => {
										return <div id="image" data-aos="fade-up" className=" overflow-y-hidden h-[90px] lg:h-[120px] w-[90px] bg-cover bg-no-repeat lg:w-[120px] rounded-[10px] bg-green mr-3" style={{ backgroundImage: `url(${data.image})` }} onClick={ () => setDataTeacher(TeacherData[data.id])}></div>
									})
								}
							</div>
						</div>
